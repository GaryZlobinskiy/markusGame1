...
class Game(ShowBase):
    def __init__(self):
        ...
        self.environment = loader.loadModel("Models/Environment/environment")
        ...
        self.gameOverScreen = DirectDialog(frameSize=(-0.7, 0.7, -0.7, 0.7),
                                           fadeScreen=0.4,
                                           relief=DGG.FLAT,
                                           frameTexture="Models/UI/stoneFrame.png")
        self.gameOverScreen.hide()

        self.font = loader.loadFont("Wbxkomik.ttf")

        buttonImages = (
            loader.loadTexture("Models/UI/UIButton.png"),
            loader.loadTexture("Models/UI/UIButtonPressed.png"),
            loader.loadTexture("Models/UI/UIButtonHighlighted.png"),
            loader.loadTexture("Models/UI/UIButtonDisabled.png")
        )
        ...
        music = loader.loadMusic("Defending-the-Princess-Haunted.ogg")
        music.setLoop(True)
