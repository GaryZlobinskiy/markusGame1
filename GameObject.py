...
class Player(GameObject):
    def __init__(self):
        GameObject.__init__(self,
                            Vec3(0, 0, 0),
                            "ActorModels/act_p3d_chan",
                            {
                                "walk": "ActorModels/a_p3d_chan_run",
                                "stand": "ActorModels/a_p3d_chan_idle"
                            },
                            5.0,
                            10.0,
                            "player")
        ...
        self.healthIcons = []
        for i in range(int(self.maxHealth)):
    ...
    def updateHealthUI(self):
        for i, icon in enumerate(self.healthIcons):
            if i < self.health:
                icon.show()
            else:
                icon.hide()
